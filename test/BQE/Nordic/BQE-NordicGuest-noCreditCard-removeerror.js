...
describe('BQE Nordic EC Order Process - guest',()=>{
    ...
    it('Guest Checkout Test',async function(){
        ...
        await page.waitForSelector('#maincontent > div.columns > div > div.cart-summary > ul > li:nth-child(3) > button')
        ...
        await page.waitForTimeout(10000)//等待10000毫秒
        await page.waitForSelector('#maincontent > div.columns > div > div.cart-summary > ul > li:nth-child(3) > button')
        await page.click('#maincontent > div.columns > div > div.cart-summary > ul > li:nth-child(3) > button')
        await shouldNotExist(page,'#maincontent > div.columns > div > div.cart-summary > ul > li:nth-child(3) > button')
        ...
        //await page.click('#shipping-new-address-form > div:nth-child(6) > div > select:nth-child(1)')
        //await page.select('#shipping-new-address-form > div:nth-child(6) > div > select:nth-child(1)','Sweden')//在Country of residence欄位選擇Sweden/Denmark/Finland
        ...
        await page.type('#shipping-new-address-form > fieldset > div > div > div > input','Brinellvägen 8, 114 28 Stockholm',{delay:100})//在street address欄位輸入address
        await page.waitForTimeout(10000)//等待10000毫秒
        await page.keyboard.press('Enter')
        //await page.goBack(),//因為address會跑出list,所以先返回上一頁
        //await page.waitForSelector('h1')
        //await page.goForward()//按下一頁
        ...
        await page.waitForTimeout(100)//等待5000毫秒
        ...
        await page.reload()//key完資料後會一直loading,所以先重整
        await page.waitForTimeout(15000)//等待15000毫秒
        const selectSwedenMore = await page.$('select[name="country_id"]');
        await selectSwedenMore.type('Sweden');
        await page.waitForTimeout(15000)//等待15000毫秒
